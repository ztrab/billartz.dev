<template>
  <div class="h-full flex flex-col lg:flex-row justify-center md:justify-between mx-auto max-w-1440">
    <div class="flex flex-col justify-between px-5 py-5 lg:py-20 lg:pr-20 xl:pr-0 xl:pl-20 w-full lg:min-w-[400px] lg:max-w-[675px] lg:h-screen">
      <MyBio />
      <div class="mt-10 lg:mt-0 flex flex-row justify-start text-secondary">
        <a class="group inline-flex items-center transition-all duration-200 ease-in-out" href="https://www.linkedin.com/in/bill-artz-45a754b/" target="_blank">
          <TrendingUpIcon class="w-10 h-10" aria-hidden="true" />
    ...
    <div class="flex flex-col px-5 py-5 lg:py-20 lg:pr-10 xl:pl-0 xl:pr-20 group w-full lg:max-w-[675px]">
      <ContentBox
      ...
      <ContentBox
        sub-title="TBD"
        title="Coming Soon"
        body-content="Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit..."
      />
      <ContentBox
        sub-title="TBD"
        title="Coming Soon"
